...
const TOPICS: Topic[] = [
  { id: 1, category: "생활 속 궁금증", title: "맨홀 뚜껑은 왜 대부분 동그랄까? 네모나면 안 되는 이유", thumbnailHook: "맨홀은 왜 동그랄까?", brief: "매일 보지만 이유는 잘 모르는 대표적인 생활 호기심형 소재. 원형 구조의 안전성과 작업 편의를 쉽게 설명합니다." },
  { id: 2, category: "신비로운 자연", title: "구름은 그렇게 무거운데 왜 하늘에서 떨어지지 않을까?", thumbnailHook: "구름은 왜 안 떨어질까?", brief: "엄청난 양의 물을 품은 구름이 떠 있는 이유를 물방울 크기와 공기의 움직임으로 풀어내는 강한 호기심형 주제입니다." },
  { id: 3, category: "생활 속 궁금증", title: "비행기 창문은 왜 네모가 아니라 둥글까?", thumbnailHook: "비행기 창문, 왜 둥글까?", brief: "익숙한 비행기 창문 모양에 숨은 구조적 이유를 압력과 응력 분산 관점에서 설명하는 생활 과학 주제입니다." },
  { id: 4, category: "신기한 동물이야기", title: "문어의 피는 왜 빨간색이 아니라 파란색일까?", thumbnailHook: "문어 피는 왜 파랄까?", brief: "사람과 다른 문어의 산소 운반 방식을 파란 혈액이라는 강한 시각적 호기심에서 출발해 설명합니다." },
  { id: 5, category: "생활 속 궁금증", title: "페트병 바닥은 왜 평평하지 않고 울퉁불퉁할까?", thumbnailHook: "페트병 밑은 왜 이럴까?", brief: "늘 손에 들고 있지만 거의 의식하지 않는 구조를 압력과 강도, 안정성과 연결하는 생활 호기심형 소재입니다." },
  { id: 6, category: "신비로운 자연", title: "달은 왜 밤이 아닌 낮에도 보일까?", thumbnailHook: "대낮에 달이 왜 보여?", brief: "낮에 보이는 달이라는 익숙한 장면을 달의 공전 위치와 햇빛 반사 원리로 쉽게 설명하는 자연 검색형 주제입니다." },
  { id: 7, category: "생활 속 궁금증", title: "자동차 타이어는 왜 전부 검은색일까? 고무 원래 색도 검정일까?", thumbnailHook: "타이어는 왜 다 검정일까?", brief: "너무 익숙해서 지나치기 쉬운 타이어 색의 이유를 재료와 내구성 관점에서 검증해 설명하는 생활형 소재입니다." },
  { id: 8, category: "신기한 동물이야기", title: "올빼미는 어떻게 목을 거의 뒤까지 돌릴 수 있을까?", thumbnailHook: "목이 어떻게 여기까지 돌아가?", brief: "강한 사진 후킹이 가능한 동물 주제. 올빼미의 목뼈와 혈관 구조가 큰 회전을 어떻게 견디는지 설명합니다." },
  { id: 9, category: "신비로운 자연", title: "번개는 보이는데 천둥소리는 왜 몇 초 뒤에 들릴까?", thumbnailHook: "천둥은 왜 늦게 들릴까?", brief: "누구나 경험한 번개와 천둥의 시간차를 빛과 소리의 속도 차이로 풀어내고 거리 감각까지 연결하는 자연 과학 주제입니다." },
  { id: 10, category: "생활 속 궁금증", title: "과자 봉지는 왜 내용물보다 훨씬 빵빵하게 만들어 놓을까?", thumbnailHook: "과자봉지는 왜 이렇게 빵빵할까?", brief: "과자 봉지 속 공간과 기체가 왜 필요한지 제품 보호와 산화 방지 관점에서 설명하는 생활 검색형 소재입니다." },
]

const STORAGE_KEY = "paramma-publish-queue-v2";
const DB_NAME = "paramma-blogger-images-v2";
