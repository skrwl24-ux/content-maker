...
- 실제 최종 글에 '20pt', '18pt', '15pt', '13~14pt' 같은 편집 지시문을 문장으로 출력하지 말 것.
- 일반 본문은 기본 본문 크기로 유지하고 제목과 소제목만 크기를 키울 것.
- 제목은 화면에서 가장 크게, 소제목은 제목보다 작고 본문보다 크게 보이도록 제목 스타일을 적용할 것.
- 소제목은 굵게 보이도록 할 것.
- ChatGPT가 제목 스타일/마크다운 렌더링을 지원하면 제목과 소제목에만 제목 스타일을 사용해 크기 차이가 실제 화면에서 보이게 할 것.
- 사용자가 복사할 때 제목·소제목·본문의 구분이 명확해야 할 것.
...
- 코드블록/HTML 사용 없음, 제목·소제목 외 불필요한 마크다운 사용 없음
